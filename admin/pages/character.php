<?php
	...
	if(isset($_GET['delete_id']))
	{
		...
		unlink("../../assets/characters/".$imgRow['fie_locatio']);
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <a class="btn btn-default pull-right" href="addch.php"> <span class="glyphicon glyphicon-plus"></span> &nbsp; add new </a>
                    </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
		...
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			?>
                                        <tr>
                                            ...
                                            <td>
                                            <span>
				<a class="btn btn-info" href="editch.php?edit_id=<?php echo $row['id_ch']; ?>" title="click for edit" onclick="return confirm('sure to edit ?')"><span class="glyphicon glyphicon-edit"></span> Edit</a> 
				<a class="btn btn-danger" href="?delete_id=<?php echo $row['id_ch']; ?>" title="click for delete" onclick="return confirm('sure to delete ?')"><span class="glyphicon glyphicon-remove-circle"></span> Delete</a>
				</span>
                                            </td>
                                        </tr>
                                        <?php
