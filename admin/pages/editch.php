...
<body>
	...
	<div class="page-header">
    	<h1 class="h2">update character. <a class="btn btn-default" href="character.php"> all character </a></h1>
    </div>
...
<form method="post" enctype="multipart/form-data" class="form-horizontal">
    ...
    <tr>
        ...
        <td>
        	<p><img src="../assets/characters/<?php echo $file_location; ?>" height="150" width="150" /></p>
        	<input class="input-group" type="file" name="ch_image" accept="image/*" />
        </td>
    </tr>
    ...
    <tr>
        ...
        <a class="btn btn-default" href="character.php"> <span class="glyphicon glyphicon-backward"></span> cancel </a>
