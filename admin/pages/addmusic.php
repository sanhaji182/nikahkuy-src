	...
	if(isset($_POST['btnsave']))
	{
		...
		if(!isset($errMSG))
		{
			...
			if($stmt->execute())
			{
				...
				header("refresh:3;music.php"); // redirects image view page after 5 seconds.
			}
			else
			{
...
<body>
    ...
    <div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="music.php"><i class="fa fa-image fa-fw"></i> Background</a>
                        </li>                        
                        <li>
        ...
        <div class="page-header">
            <h1 class="h2">add new Music. <a class="btn btn-default" href="music.php"> <span class="glyphicon glyphicon-eye-open"></span> &nbsp; view all </a></h1>
        </div>
    ...
    <form method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <tr>
            ...
            <td><input class="input-group" type="file" name="musicfile" accept="audio/*" /></td>
        </tr>
